...
class doMath:
    ...
    def timeCalc(totalsec):
        ...
        return ('Total Time Running: %s hrs, %s mins, %s secs' % (totalhr, totalmin, abs(totalsec)))
...
class game:
    ...
    def turn(turn):
        ...
        game.printdata()
        print('')
        posx = input('What row would you like to play %s in? (A, B, C) ' % player)
        ...
        if posx != 'A' and posx != 'B' and posx != 'C':
            ...
            if posy != '1' and posy != '2' and posy != '3':
                ...
                try:
                    ...
                    if success:
                        print('Played %s in row %s, collom %s.' % (player, posx, posy))
                        print('')
                    else:
                        print('That spot is not playable. Please enter another location.')
                        print('')
                        toret = True
        return toret
